...
After that, you should have a directory called `thumbnail-generator` with all the files necessary to run the script.<br>
The installation is very simple, just run the install script (`install.sh`) and it will do the rest for you, but pay attention to the initial setup 👇.
